...
"2": {
"name": "生成AI製品エキスパート",
"description": "生成AI関連製品、技術に関する専門的な質問に答える",
"details": "生成AI や関連製品、技術に関する専門的な質問に対して、最新の情報と深い洞察を提供してください。"
},
"3": {
"name": "カウンセラー",
...
from langchain_core.configurables import ConfigurableField
